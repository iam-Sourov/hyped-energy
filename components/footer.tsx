    ...
    <footer className="py-24 px-6 lg:px-22 bg-background border-t border-black/5">
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-16">
        <div className="md:col-span-6">
          <h2 className="text-6xl md:text-9xl font-[900] mb-12 tracking-tighter leading-none">LETS GET<br /><span className="text-primary tracking-tighter decoration-primary decoration-4 underline-offset-8">HYPED.</span></h2>
          <Link 
            href="mailto:hello@gethyped.agency" 
            className="text-2xl md:text-4xl font-black hover:text-primary transition-colors inline-block"
          >
        ...
        <div className="md:col-span-3">
          <h4 className="font-bold tracking-widest text-foreground/30 mb-8 uppercase text-xs">Navigation</h4>
        ...
        <div className="md:col-span-3">
          <h4 className="font-bold tracking-widest text-foreground/30 mb-8 uppercase text-xs">Social</h4>
          <ul className="flex flex-col gap-4 font-bold">
      ...
      <div className="max-w-[1600px] mx-auto mt-24 pt-12 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-8 text-foreground/40 font-bold text-xs tracking-widest">

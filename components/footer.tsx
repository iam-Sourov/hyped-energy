...
export const Footer = () => {
  ...
  return (
    ...
    >
      ...
      {/* 2. Top CTA Section */}
      <div className="relative z-10 flex w-full flex-col items-center justify-center bg-transparent px-6 py-12 text-center md:hidden lg:flex md:h-[40vh] md:py-0 md:pt-[8vh]">
      ...
      <div className="relative mt-auto w-full md:absolute md:bottom-0 md:mt-[10vh]">
        {/* 1. Slanted Background Wrapper */}
        <div className="absolute inset-x-0 bottom-0 z-0 mx-[4vw] h-[60vh] min-h-[500px] overflow-hidden md:mx-[2vw] md:h-[65vh] md:min-h-0">
          <div
            className="absolute inset-x-0 bottom-0 origin-right bg-[#EBE4D5] md:inset-0"
            style={{
              transform: "skewY(-11deg) translateY(5%)",
              height: "160%",
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1920px] px-[6vw] pb-[8vh] md:px-[5vw] md:pb-0">
          <div className="flex flex-col items-center justify-between gap-[5vh] md:flex-row md:items-end md:gap-[4vw]">

            {/* Logo Section */}
            <div className="flex w-full justify-center md:w-[35%] md:justify-start md:pb-0">
              <Logo className="h-auto w-[65vw] max-w-[320px] origin-bottom transform text-black md:w-full md:max-w-none md:scale-y-110" />
            </div>

            {/* Content Groups */}
            <div className="flex w-full flex-col items-center gap-[4vh] md:w-auto md:items-end md:gap-[3vh]">

              {/* Navigation Pills */}
              <nav className="flex w-full items-center justify-center gap-[3vw] border-b border-black/10 pb-[3vh] md:w-auto md:justify-end md:gap-[1vw] md:border-none md:pb-0">
                {["Expertise", "Work", "About", "Contact"].map((item, idx) => (
                  <Link
                    key={item}
                    href={`#${item.toLowerCase()}`}
                    className="nav-swoosh-btn relative inline-flex items-center justify-center overflow-hidden rounded-xl border border-black/5 bg-white px-[5vw] py-[1.5vh] font-bold text-black shadow-sm md:px-[1.5vw] md:py-[1vh] md:shadow-none"
              ...
              <div className="flex w-full flex-col gap-[4vh] text-center md:w-auto md:flex-row md:gap-[5vw] md:text-left">
                {/* Socials */}
                ...
                {/* Address */}
                <div className="flex flex-col items-center gap-[0.5vh] md:items-start md:gap-[1vh]">
                  <p className="hidden text-[clamp(12px,1.2vw,14px)] font-bold text-black/60 md:block">Address</p>
                  <div className="text-[clamp(14px,1.3vw,16px)] font-semibold leading-relaxed">
              ...
              {/* Metadata Bar */}
              <div className="mt-[2vh] flex w-full flex-col items-center justify-between gap-[2vh] border-t border-black/10 pt-[3vh] text-[clamp(10px,1vw,12px)] font-bold text-black/40 sm:flex-row md:mt-0 md:pt-[4vh]">
                <p>© 2026 Get Hyped</p>
                <p>Design by Rakib</p>
...
const CircularBadge = () => (
  <div className="relative flex -top-[9vw] h-[10vw] w-[10vw] -rotate-12 items-center justify-center">
    ...
    <div className="z-10 rotate-26 flex h-[4vw] w-[4vw] items-center justify-center rounded-full ">
      <span className="text-[3.5vw] font-[900] tracking-tighter text-black">GH</span>
    </div>
  </div>
)
